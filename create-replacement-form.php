            ...
            <header class="bg-white shadow-sm">
                <div class="flex items-center justify-between p-3">
                    ...
                    <div class="flex space-x-3">
                        <button type="submit" form="replacementForm" class="bg-orange-600 text-white py-1.5 px-4 rounded text-sm hover:bg-orange-700 flex items-center">
                            <i class="fas fa-save mr-1 text-xs"></i> Save
                        </button>
                        <button type="reset" form="replacementForm" class="bg-gray-300 text-gray-700 py-1.5 px-4 rounded text-sm hover:bg-gray-400 flex items-center">
            ...
            <main class="flex-1 overflow-y-auto p-4">
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
                        <form id="replacementForm" action="" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-4 compact-section">
                            <!-- Left Column -->
                            <div class="space-y-3">
